...
suppress_warnings = [ 'misc.highlighting_failure', 'autosectionlabel.*' ]
...
latex_documents = [
    (master_doc, 'Daedalus.tex', 'Daedalus Documentation',
     'The Daedalus Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'daedalus', 'Daedalus Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Daedalus', 'Daedalus Documentation',
     author, 'Daedalus', 'One line description of project.',
     'Miscellaneous'),
]
