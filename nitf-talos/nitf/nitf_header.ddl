...
def ImgLens =
  block
    talos_fixup_offset = TalosOffset
    lish = BoundedNum 6 439 999998
    li = BoundedPos 10 100 -- BoundedPos 10 9999999999
...
def GraphLens =
  block
    ...
    seglen = BoundedPos 6 100 -- BoundedPos 6 999999
...
def TextLens =
  block
    ...
    lt = BoundedPos 5 1000 -- BoundedPos 5 999999

def DataExtLens =
  block
    talos_fixup_offset = TalosOffset  
    ldsh = BoundedNum 4 200 9999
    ld = BoundedPos 9 1000 -- BoundedPos 9 999999999
...
def ResExtLens =
  block
    ...
    lre = BoundedPos 7 1000 -- BoundedPos 7 9999999
...
def Header = block
  ...
  TalosGuard (numdes < 10)  
  dataextlens = Many (numdes as! uint 64) DataExtLens

  @numres = UnsignedNum 3
  TalosGuard (numres == 0) -- Currently the spec is a bit broken
